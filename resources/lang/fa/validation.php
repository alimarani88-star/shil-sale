...
return [
    ...
    'attributes' => [
        ...
        'copan' => 'کد تخفیف',
        'subject' => 'عنوان',
        'product_group_id_in_app' => 'گروه کالا',
        'product_name_id_in_app' => 'نام کالا',
        'product_name' => 'نام کالا',
        'price_unit' => 'واحد پولی',
        'guarantee' => 'مدت گارانتی',
        'sales_start_date' => 'تاریخ شروع فروش',
        'sales_end_date' => 'تاریخ پایان فروش',
        'image1' => 'تصویر یک',
        'image2' => 'تصویر دو',
        'image3' => 'تصویر سه',
        'image4' => 'تصویر چهار',
        'meta_key.*' => 'انتخاب ویژگی',
        'meta_value.*' => 'مقدار ویژگی',
        'company_name' => "نام شرکت",
        'instagram' => "اینستاگرام شرکت",
        'linkedin' => "لنکدین شرکت",
        'field_activity_company' => "زمینه کاری شرکت",
        'working_hours' => "ساعات کاری شرکت",
        'main_image' => 'تصویر اصلی',
        'categories' => 'دسته بندی عمومی',
        'prd_categories' => 'دسته بندی محصولات',
        'reading_time' => 'زمان مطالعه',
        'meta_keywords' => 'کلمه های کلیدی',
        'meta_description' => 'توضیحات متا',
        'alt_main_image' => 'توصیف تصویر اصلی',
        'discount_type' => 'نوع تخفیف',
        'group_name' => 'گروه کالا',
        'percentage_discount' => 'درصد تخفیف',
        'percentage_start_date' => 'تاریخ شروع تخفیف',
        'percentage_end_date' => 'تاریخ پایان تخفیف',
        'group' => 'گروه کالا',
