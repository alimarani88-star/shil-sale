...
<head>
    ...
    <link href="assets/css/plugins/AddTags.css" rel="stylesheet">
    ...
    <div class="container">
        <div class="navbar-translate">
            <a class="navbar-brand" href="#pablo">
                <img src="assets/img/logo.svg" height="24px" alt="">
            </a>
                            ...
                            <ul class="basket-list">
                                ...
                                <li>
                                    <a href="#" class="basket-item">
                                        ...
                                        <div class="basket-item-content">
                                            <div class="basket-item-image">
                                                <img alt="" src="assets/img/cart/1335154.jpg">
                                            </div>
                                            <div class="basket-item-details">
                                                <div class="basket-item-title">گوشی موبایل اپل مدل iPhone X ظرفیت
                                                    256
                                                    گیگابایت
                                                </div>
                                                <div class="basket-item-params">
...
<!--  AddTags -->
<script src="assets/js/plugins/Obj.js"></script>
<script src="assets/js/plugins/AddTags.js"></script>
<!-- Main Js -->
