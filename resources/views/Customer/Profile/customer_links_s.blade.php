        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-12 text-center mb-5">
                    <h1 class="title-tab-content">لیست قیمت و کاتالوگ محصولات سیم و کابل ایرانیان</h1>
                    ...
                    <a href="{{ url('/documents/pricelist.pdf') }}" target="_blank" class="card-download text-decoration-none">
                        <div class="card shadow-sm h-100">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center">
                                ...
                                <p class="card-text text-muted text-center">آخرین نسخه لیست قیمت محصولات سیم و کابل ایرانیان</p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="{{ url('/documents/catalog1.pdf') }}" target="_blank" class="card-download text-decoration-none">
                        <div class="card shadow-sm h-100">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center">
                                ...
                                <p class="card-text text-muted text-center">کاتالوگ کامل محصولات سیم و کابل ایرانیان</p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="{{ url('/documents/representatives_list.pdf') }}" target="_blank" class="card-download text-decoration-none">
                        <div class="card shadow-sm h-100">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center">
                                ...
                                <p class="card-text text-muted text-center">لیست کامل نمایندگان سیم و کابل ایرانیان</p>
                            </div>
                        </div>
                    </a>
                </div>
