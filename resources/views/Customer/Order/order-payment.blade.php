                                                ...
                                                <button class="btn btn-link" type="button" data-toggle="collapse"
                                                    ...
                                                    <div class="checkout-order-summary-row">
                                                        ...
                                                        <div
                                                            ...
                                                            <span class="dl-none-sm">پست پیشتاز</span>
                                                        </div>
                                                        <div
                                                            class="checkout-order-summary-col checkout-order-summary-col-how-to-send">
                                                            <span>ارسال از</span>
                                                            <span class="fs-sm">2 روز کاری</span>
                                                        </div>
                                                        <div
                                                            class="checkout-order-summary-col checkout-order-summary-col-shipping-cost">
                                                            <span>هزینه ارسال</span>
                                                            <span class="fs-sm" style="color: #fb3449;">
                                                                {{ number_format($price_send) }} ریال
                                                            </span>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="product-box-container">
                                                                    <div class="product-box product-box-compact">
                                                                        <a class="product-box-img">
                                                                            <img src="{{ url('get_image_by_id/' . $cart->product->images->first()->id) }}"
                            ...
                            <div class="checkout-summary">
                                <div class="checkout-summary-main">
                                    <ul class="checkout-summary-summary">
                                        ...
                                        <li>
                                            <span>هزینه ارسال</span>
                                            <span style="color: #fb3449;">{{ number_format($price_send) }} ریال</span>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="checkout-summary-content">
                                        ...
                                        <div class="checkout-summary-price-value">
                                            <span
                                                class="checkout-summary-price-value-amount">{{ number_format($totalProfit) }}</span>
                                            ریال
                                        </div>
