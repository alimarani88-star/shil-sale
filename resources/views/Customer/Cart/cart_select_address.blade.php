...
{{--                                        <span class="checkout-additional-options-checkbox-image"></span>--}}
                                        <div>
                                            <p class="p-2 d-flex align-items-center" style="gap: 8px; color: #316302; font-size: 1.15rem;">
                                                <img src="{{ asset('assets/img/tipax.jpg') }}" alt="تیپاکس" style="height: 45px; width: auto;">
                                                <span>مرسوله توسط تیپاکس و به صورت پس کرایه ارسال می گردد .</span>
                                            </p>
