                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="product-gallery default">
                                    <img class="zoom-img" id="img-product-zoom" src="{{$product['img_url_1']}}"
                                         data-zoom-image="{{$product['img_url_1']}}" width="411" />

                                    <div id="gallery_01f" style="width:500px;float:left;">
                                        <ul class="gallery-items owl-carousel owl-theme" id="gallery-slider">
                                            <li class="item">
                                                <a href="#" class="elevatezoom-gallery active" data-update=""
                                                   data-image="{{$product['img_url_1']}}"
                                                   data-zoom-image="{{$product['img_url_1']}}">
                                                    <img src="{{$product['img_url_1']}}" width="100" /></a>
                                            </li>
                                            <li class="item">
                                            ...
                                            <li class="item">
                                                <a href="tester" class="elevatezoom-gallery"
                                                   ...
                                                   class="slide-content"><img
                                                        src="/assets/img/product/110197298.jpg" height="68" /></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
