        ...
        <section class="row">
            <section class="col-12">
                <section class="main-body-container">
                    ...
                    <section>
                        <form action="{{route('A_s_create_product')}}" method="post" enctype="multipart/form-data" id="form">
                            @csrf
                            <section class="row">
                                ...
                                <section class="col-12 border-top border-bottom py-3 mb-3">
                                    ...
                                    <section>
                                        <button type="button" id="btn-copy" class="btn btn-success btn-sm">افزودن
                                        </button>
                                    </section>
