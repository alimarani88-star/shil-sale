    ...
    <div class="container-fluid pt-2">
        <nav aria-label="breadcrumb" class="mt-0 px-3">
            <ol class="breadcrumb p-2">
                ...
                <li class="breadcrumb-item font-size-12 active" aria-current="page">تخفیف ها</li>
                <li class="breadcrumb-item font-size-12 active" aria-current="page">ایجاد تخفیف</li>
            </ol>
        </nav>
        ...
        <section class="row">
            <div class="col-12">
                <section class="main-body-container">
                    ...
                    <div>
                        <form action="{{ route('A_s_create_discount') }}" method="post"
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="discount_type" id="discount_type" class="form-control form-control-sm select2">
                                            <option value="amazingsale" @if(old('discount_type') == 'amazingsale') selected @endif>تخفیف شگفت انگیز</option>
                                            <option value="common" @if(old('discount_type') == 'common') selected @endif>تخفیف عمومی</option>
                                        </select>
                                        @error('discount_type')
                                        <span
                                            class="alert_required bg-danger text-white p-1 rounded d-inline-block mt-1"
