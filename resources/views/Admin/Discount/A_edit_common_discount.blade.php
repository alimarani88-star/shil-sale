        ...
        <section class="row">
            <div class="col-12">
                <section class="main-body-container">
                    ...
                    <div>
                        <form action="{{ route('A_s_edit_common_discount' , $productinfo->id) }}" method="post"
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="discount_type" name="discount_type"
                                            ...
                                            <option value="maingroup" @if(old('discount_type',$productinfo->discount_type) == 'maingroup') selected @endif>
                                                تخفیف گروه اصلی کالا
                                            </option>
                                            <option value="group" @if(old('discount_type',$productinfo->discount_type) == 'group') selected @endif>
                                                تخفیف گروه کالا
                                            </option>
                                            <option value="product"
                                                    @if(old('discount_type',$productinfo->discount_type) == 'Product') selected @endif>تخفیف کالا
                                            </option>
                                        </select>
                                        @error('discount_type')
                                        <span
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm select2"
                                            ...
                                            @foreach($maingroups['data'] as $maingroup)
                                                <option
                                                    value="{{ $maingroup['id'] }}" {{$productinfo->target_type == 'main_group' && old('main_group_id',$productinfo->target_id) == $maingroup['id'] ? 'selected' : '' }}>
                                                    {{ $maingroup['name'] }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm select2"
                                            ...
                                            @foreach($groups['data'] as $group)
                                                <option
                                                    value="{{ $group['id'] }}" {{$productinfo->target_type == 'group' && old('group_id',$productinfo->target_id) == $group['id'] ? 'selected' : '' }}>
                                                    {{ $group['title'] }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm select2"
                                            ...
                                            @foreach($products as $product)
                                                <option
                                                    value="{{ $product['id'] }}" {{ $productinfo->target_type == 'product' && old('product_id',$productinfo->target_id) == $product['id'] ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm select2"
                                            ...
                                            @foreach($discounts as $discount)
                                                <option
                                                    value="{{ $discount['id'] }}" {{ old('discount_id',$productinfo->discount_id) == $discount['id'] ? 'selected' : '' }}>
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="percentage_discount" id="percentage_discount"
                                               value="{{ old('percentage_discount',$productinfo->percentage) }}"
                                    ...
                                    <div class="col-8">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" class="form-control form-control-sm"
                                                      rows="6">{{ old('description',$productinfo->description) }}</textarea>
                                            @error('description')
                                            <span
                                                class="alert_required bg-danger text-white p-1 rounded d-inline-block mt-1"
                                                role="alert"><strong>{{ $message }}</strong></span>
